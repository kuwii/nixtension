...
in
{
  ...
  config = mkMerge [
    ...
    (mkIf (cfg.enable && cfg.git.enable) (import ./features/git/home.nix { inherit pkgs; }))
    ...
    (mkIf (cfg.enable && cfg.fuzzy-finder.enable) (import ./features/fuzzy-finder/home.nix { inherit pkgs; }))
